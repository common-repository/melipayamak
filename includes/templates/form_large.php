...
<html lang="en">
	<head>
		...
		<style>
			...
			.melipayamak_group_box:focus, .textbox_melipayamak_box:focus,{
			...
			<?php $color=(get_option('melipayamak_ilbg') != 'none')? get_option('melipayamak_ilbg') : ''; ?>
			.melipayamak_name{
			...
			<?php $color=(get_option('melipayamak_ilhbg') != 'none')? get_option('melipayamak_ilhbg') : ''; ?>
			...
			.melipayamak_box {
				width: 100%;
				background:  <?php echo get_option('melipayamak_form') ?>;
				border-radius: 3px;
				padding: 10px 0px;
				padding-top:5px;
			}
			.textbox_melipayamak_box {
				transition: 0.2s;
				padding-right: 50px;
	...
	<body>
     ...
     <section class="melipayamak_box">
        <div class="mpnew">
        	<input maxlength="255" type="text" class="textbox_melipayamak_box melipayamak_fname melipayamak_name" placeholder="نام">
			<input maxlength="255" type="text" class="textbox_melipayamak_box melipayamak_name melipayamak_lname" placeholder="نام خانوادگی">
			<input type="text" class="textbox_melipayamak_box melipayamak_mobile" placeholder="موبایل">
			<select style="width: 48% !important;margin: 5px 1.18% 0px 0px;" class="melipayamak_group_box melipayamak_gender">
				<option  disabled selected value="">جنسیت</option>
				<option value="1">زن</option>
				<option value="2">مرد</option>
			</select>
			<select  class="melipayamak_group_box melipayamak_group">
				<option disabled selected value="">گروه کاربری</option>
				<?php echo $melipayamak -> fetch_phonebook_groups(true,'',false,true) ?>
			</select>
			<input type="submit" id="submit_melipayamak" class="submit_melipayamak_box" value="اشتراک یا لغو اشتراک">
        </div>
			<div style="display:none" class="mpcode">
				<div id="mpcode"></div>
					<input style="width: 97.7%;" type="text" class="textbox_melipayamak_box melipayamak_code" placeholder="کد تایید">
				<input type="submit" id="submitcmp" class="submit_melipayamak_box" value="ارسال کد تایید">
			</div>
		</section>
		</form>
	</body>
